...
import EditProgramModal from "../modal/edit-program";
type Payment = {
  id: string;
  student_id: string;
  amount: number;
...
const [editingPayment, setEditingPayment] = useState<any | null>(null);
  ...
  const handleEdit = (student: StudentPaymentSummary) => {
    console.log("Edit payment for:", student);
    // You can route to an edit page or open a modal here
  };
  ...
  <button
    ...
    onClick={() => setEditingPayment(student)}
  >
    Edit
  </button>
</TableCell>
      ...
      <EditPaymentModal
        ...
        onSuccess={() => {
          ...
          refreshData(); // your refetch logic
        }}
      />
    )} */}
    </div>
